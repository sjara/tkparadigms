...
coop026x027 = {'subject':'coop026x027', 'experimenter':'juan', **coopStage4, 'pokesPerMouse': 10, "activatePokeIncrement":"False", "targetPokesPerMouse": 10, "numberOfPokeAddPerMouse":3, "thresholdForIncrementPoke":10} 
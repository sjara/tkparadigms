...
pamo027.update(stage1)
pamo028.update(stage1)
pamo029.update(stage1)
pamo030.update(stage1)
pamo031.update(stage1)
pamo032.update(stage1)
pamo033.update(stage1)
pamo034.update(stage1)
pamo035.update(stage1)
pamo036.update(stage1)
pamo037.update(stage1)
pamo038.update(stage1)
pamo039.update(stage1)
pamo040.update(stage1)
pamo041.update(stage1)

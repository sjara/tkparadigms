...
pamo027.update(stage2)
pamo028.update(stage2)
pamo029.update(stage2)
pamo030.update(stage2)
pamo031.update(stage2)
pamo032.update(stage2)
pamo033.update(stage2)
pamo034.update(stage2)
pamo035.update(stage2)
pamo036.update(stage2)
pamo037.update(stage2)
pamo038.update(stage2)
pamo039.update(stage2)
pamo040.update(stage2)
pamo041.update(stage2)

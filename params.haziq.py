...
pamo009.update(stage3)
pamo010.update(stage3)
pamo011.update(stage3)
pamo012.update(stage3)
pamo013.update(stage3)
pamo014.update(stage3)
pamo015.update(stage3)
pamo016.update(stage3)
pamo017.update(stage3)
pamo018.update(stage3)
pamo019.update(stage3)
pamo020.update(stage3)

...
pamo033.update(stage3) # performed more than 30% with antibias mode on (Fifth day)
pamo034.update(stage3) # performed more than 30% with antibias mode on (Fifth day)

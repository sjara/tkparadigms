...
pamo030.update(stage3) # performed more than 30% with antibias mode on (Ninth day)
pamo031.update(stage3) 
pamo032.update(stage3) # just above 20 %
pamo033.update(stage3); pamo033.update(antibias) # Nineth day
pamo034.update(stage3) # just above 20 % 

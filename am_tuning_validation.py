...
class Paradigm(QtWidgets.QMainWindow):
    def __init__(self, parent=None, paramfile=None, paramdictname=None):
        ...
        self.params['soundTrialsFraction'] = paramgui.NumericParam('Fraction of trials with sound',
                                                                   value=1,
        ...
        self.params['soundTrial'] = paramgui.NumericParam('Sound Trial?',value=1,
                                                           enabled=False,
                                                           group='Stim parameters',
                                                           decimals=0)
    ...
    def prepare_next_trial(self, nextTrial):
        ...
        fractionSoundTrials = self.params['soundTrialsFraction'].get_value()
        soundTrial = np.random.rand(1)[0]<fractionSoundTrials
        self.params['soundTrial'].set_value(int(soundTrial))

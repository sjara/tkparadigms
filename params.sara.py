...
amDiscrimStage21 = {'experimenter':'sara', 'outcomeMode':'on_next_correct', 'delayToTargetMean':0.01, 'delayToTargetHalfRange':0, 
                    'allowEarlyWithdrawal':'off', 'punishTimeEarly': 0.2, 'punishSoundIntensity':60, 'targetMaxIntensity':60, 'targetIntensityMode':'fixed',
                    'targetDuration': 0.25, 'automationMode':'increase_duration', 'visibleLightMode':'center',  'lightMode': 'on', 'lightOffset': 'side_poke'}
...
amDiscrimStage22 = {'experimenter': 'sara', 'outcomeMode': 'only_if_correct', 'delayToTargetMean': 0.1, 'delayToTargetHalfRange': 0, 'targetDuration': 0.5,
...
amDiscrimBiasCorr22 = {'experimenter':'sara', 'outcomeMode':'only_if_correct', 'delayToTargetMean':0.1, 'delayToTargetHalfRange':0, 'allowEarlyWithdrawal':'on', 'punishTimeError':0,
...
sole072 = {'subject':'sole072', **amDiscrimStage20}
sole073 = {'subject':'sole073', **amDiscrimStage20}
sole074 = {'subject':'sole074', **amDiscrimStage20}
sole075 = {'subject':'sole075', **amDiscrimStage20}
sole076 = {'subject':'sole076', **amDiscrimStage20}
sole077 = {'subject':'sole077', **amDiscrimStage20}
sole078 = {'subject':'sole078', **amDiscrimStage20}
sole079 = {'subject':'sole079', **amDiscrimStage20}
sole080 = {'subject':'sole080', **amDiscrimStage20}
sole081 = {'subject':'sole081', **amDiscrimStage20}
sole082 = {'subject':'sole082', **amDiscrimStage20}

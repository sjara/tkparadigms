...
class Paradigm(QtWidgets.QMainWindow):
    ...
    def populate_sound_params(self):
        ...
        productList = list(itertools.product(toneList, modList, ampList))
    ...
    def prepare_next_trial(self, nextTrial):
        ...
        elif stimType in ['SAM']:
            targetAmp = self.noiseCal.find_amplitude(self.trialParams[2])
        else:
        ...
        if stimType == 'Sine':
            ...
            sound = {'type':'SAM', 'duration':stimDur, 'toneFrequency':self.trialParams[0],
                     'amplitude':targetAmp,'modFrequency':self.trialParams[1]}
